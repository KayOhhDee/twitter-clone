  ...
  <div>
    <div class="flex items-center flex-shrink-0 p-4 pb-0">
      <div class="flex w-12 items-top">
        <img :src="props.user?.profileImage || '/images/avatar.jpg'" :alt="user.name" class="inline-block w-10 h-10 rounded-full">
      </div>
    ...
    <div class="p-4 pl-16">
      <img :src="inputImageUrl" v-if="inputImageUrl" alt="" class="rounded-2xl border" :class="defaultBorderColor" />
